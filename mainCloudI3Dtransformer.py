...
if create_csv_files:
    create_csv(train_videos, train_labels, "trainI3D2")
    create_csv(val_videos, val_labels, "valI3D2")
    create_csv(test_videos, test_labels, "testI3D2")

train_csv_path = "/public/home/cit_fluo/znb/source/videoWork/trainI3D2.csv"
val_csv_path = "/public/home/cit_fluo/znb/source/videoWork/valI3D2.csv"
test_csv_path = "/public/home/cit_fluo/znb/source/videoWork/testI3D2.csv"
...
class WorkoutClassifier(nn.Module):
    def __init__(self, num_classes=22):
        ...
        self.base_model = I3dTransformer(num_classes=num_classes, d_model=64, transformer_config={'d_ff':32, 'num_heads':8, 'dropout':0,'num_layers':2})
        self.fc2 = nn.Linear(256, num_classes)

    def forward(self, x, flows):
        batch_size, num_frames, c, h, w = x.shape
        # x shape torch.Size([8, 30, 3, 128, 128])
        tmp = x.repeat(1, 1, 2, 1, 1) 
        
        result = self.base_model(tmp)
        f = self.fc2(result["embds"])
        # print(f.shape)
        return f
