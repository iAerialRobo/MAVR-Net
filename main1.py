...
def load_video_frames(video_path, num_frames=30):
    ...
    # sample the whole frmaes
    N = len(frames)
    arr = np.arange(N)
    indices = np.linspace(0, len(arr) - 1, num_frames, dtype=int)
    frame_sampling = [frames[i] for i in indices]
...
class WorkoutDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
       ...
       # print('frame_tensor.shape', frames_tensor.shape)
...
train_csv_path = "/home/dwqdx3/videoCLS/myWorkplace/train.csv"
val_csv_path = "/home/dwqdx3/videoCLS/myWorkplace/val.csv"
test_csv_path = "/home/dwqdx3/videoCLS/myWorkplace/test.csv"
